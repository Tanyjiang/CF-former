...
def parse_args():
    ...
    parser.add_argument('--data-dir', default='/home/data/part_A_final', help='data path')
    ...
    parser.add_argument('--run-name', default='4', help='run name for wandb interface/logging')
