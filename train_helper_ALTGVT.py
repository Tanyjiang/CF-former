...
class Trainer(object):
    ...
    def setup(self):
        args = self.args
        sub_dir = (
            "CF-former/{}_12-1-input-{}_wot-{}_wtv-{}_reg-{}_nIter-{}_normCood-{}".format(
                args.run_name,
                args.crop_size,
                args.wot,
                args.wtv,
        ...
        self.dataloaders = {
            x: DataLoader(
                ...
                drop_last=(True if x == "train" else False)  # me add
            )
            for x in ["train", "val"]
        }
        ...
        if args.wandb:
            ...
            config=args, project="CF-former", name=args.run_name
        )
        else : 
